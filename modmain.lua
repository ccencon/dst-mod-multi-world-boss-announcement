...
AddPrefabPostInit("beequeenhive",function(inst)
	inst:ListenForEvent("timerdone", function()
		if inst:GetDisplayName() == "蜂蜜地块" or inst:GetDisplayName() == "Honey Patch" then
			TheNet:Announce(lightbulb.."〖 "..GetWorldName(inst).." 〗: "..heart.."〖 "..inst:GetDisplayName().." 〗"..annstring.reflash..lightbulb)
		end
	end)
end)
...
AddPrefabPostInit("dragonfly_spawner",function(inst)
	inst:ListenForEvent("timerdone", function()
		TheNet:Announce(lightbulb.."〖 "..GetWorldName(inst).." 〗: "..heart.."〖 "..annstring.dragonfly.." 〗"..annstring.reflash..lightbulb)
	end)
end)
...
AddPrefabPostInit("klaus", function(inst)
    local function announcement(inst, data)
    	...
    	if lastattacker ~= nil then
    		TheNet:Announce(trophy.."〖 "..GetWorldName(inst).." 〗: "..grave.."〖 "..inst:GetDisplayName().." 〗"..annstring.gotkilledby..heart.."〖 "..lastattacker.name.." 〗"..battle)
    	else
    		TheNet:Announce(trophy.."〖 "..GetWorldName(inst).." 〗: "..grave.."〖 "..inst:GetDisplayName().." 〗"..annstring.gotkilled..battle)
    	end
    end
